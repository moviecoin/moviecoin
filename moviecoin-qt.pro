...
contains(USE_UPNP, -) {
    ...
    LIBS += -Wl,-Bstatic $$join(MINIUPNPC_LIB_PATH,,-L,) -lminiupnpc
...
macx:TARGET = "MovieCoin-Qt"

# Set libraries and includes at end, to use platform-defined defaults if not overridden
INCLUDEPATH += $$BOOST_INCLUDE_PATH $$BDB_INCLUDE_PATH $$OPENSSL_INCLUDE_PATH $$QRENCODE_INCLUDE_PATH
LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,)
LIBS += -Wl,-Bdynamic -lssl -lcrypto
LIBS += -Wl,-Bstatic -ldb_cxx$$BDB_LIB_SUFFIX 
# -lgdi32 has to happen after -lcrypto (see  #681)
windows:LIBS += -lole32 -luuid -lgdi32 
LIBS += -Wl,-Bstatic -lboost_system$$BOOST_LIB_SUFFIX -lboost_filesystem$$BOOST_LIB_SUFFIX -lboost_program_options$$BOOST_LIB_SUFFIX -lboost_thread$$BOOST_THREAD_LIB_SUFFIX
LIBS += -Wl,-Bdynamic
contains(RELEASE, 1) {
    !windows:!macx {
