...
// Copyright (c) 2014 MovieCoin Developers
...
uint256 hashGenesisBlock("0x328e34c8e961b9cb16ebbbd4955fe13b8b42aa5cadb6f8a9e69312784022f462");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // MovieCoin: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	{
		nSubsidy = (1 + generateMTRandom(seed, 24999)) * COIN;
	}
	else if(nHeight < 500000)
	{
		nSubsidy = (1 + generateMTRandom(seed, 12499)) * COIN;
	}
	else if(nHeight < 1000000)
	{
		nSubsidy = (1 + generateMTRandom(seed, 6249)) * COIN;
	}
out:
...
static const int64 nTargetTimespan = 1 * 60 * 60;						// MovieCoin: every 1 hours diffcult
static const int64 nTargetSpacing = 60;								// MovieCoin: 60 sec
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Hsound rich your ear at fisrt, January 26, 2014 —haha bob enjoy your life etc.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392282967;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085529628;
        ...
        assert(block.hashMerkleRoot == uint256("0xa733188c1cdeba33d4d7301565465e906fe53fad5da77d9666040412dbf33091"));
...
unsigned char pchMessageStart[4] = { 0xc0, 0xdb, 0xf1, 0xec }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // MovieCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
